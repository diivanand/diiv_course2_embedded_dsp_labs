...
## Exercise 0.1 - Toolchain inventory

### clang

```shell
(base) diivanand@Mac diiv_course2_embedded_dsp_labs % clang --version 
...
```shell
(base) diivanand@Mac diiv_course2_embedded_dsp_labs % ld -v
...
```shell
(base) diivanand@Mac diiv_course2_embedded_dsp_labs % lldb --version
lldb-2100.0.17.203
...
```shell
(base) diivanand@Mac diiv_course2_embedded_dsp_labs % make --version 
GNU Make 3.81
